// Question 16
console.log("\n\n");
let guest1:string[] = ["Maham","Mahnoor","Menahil"];
for (let i = 0;i<guest1.length;i++){
    console.log(`\nI invite you for dinner tonight ${guest1[i]}`);
}

let not_present1:string = "Menahil"
...
// Question 17
console.log("\n\n");
let guest2:string[] = ["Abdul Jabbar","Maham","Taimoor","Mahnoor","Sabar","Daniyal"];
...
for (let i:number = guest2.length;i>2;i--){
